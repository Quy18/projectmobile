...
@section('title', 'Báo Cáo Khách Hàng Tiềm Năng')

@section('content')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Báo Cáo Khách Hàng Tiềm Năng</h1>
        <div>
            <button class="btn btn-sm btn-primary shadow-sm" id="exportPDF">
                <i class="fas fa-download fa-sm text-white-50"></i> Xuất PDF
            </button>
            <a href="{{ route('admin.reports.exportCSV', ['type' => 'customers']) }}" class="btn btn-sm btn-success shadow-sm">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form id="filterForm" method="GET" action="{{ route('admin.reports.topCustomers') }}">
                        <div class="row">
                        ...
                        <table class="table table-bordered" id="topCustomersTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.users.show', $customer->id) }}" class="btn btn-info btn-sm">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.users.edit', $customer->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Biểu Đồ Chi Tiêu Khách Hàng</h6>
                </div>
                <div class="card-body">
